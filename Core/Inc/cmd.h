...
// ========================================================================================
    ...
    // ========================================================================================
        ...
        // ========================================================================================
        TOTAL_LEN_PVER11_REQ   = 20,   // [11] 버전정보 요청 (바디 없음: 18 + 0 + 2) [cite: 1045]
        TOTAL_LEN_PFCR15_REQ   = 20,   // [15] 관계정보 조회 요청 (바디 없음: 18 + 0 + 2) [cite: 1142]
        TOTAL_LEN_PCN220_REQ   = 20,   // [20] 설정정보 요청 (바디 없음: 18 + 0 + 2) [cite: 1264]
        TOTAL_LEN_PRBT22_REQ   = 20,   // [22] GW 재기동 요청 (바디 없음: 18 + 0 + 2) [cite: 1330]

        TOTAL_LEN_PFST7_REQ    = 24,   // [7] 미전송자료 전송시간 변경 요청 (18 + 바디 4 + 2) [cite: 921]

        TOTAL_LEN_PTIM9_RES    = 32,   // [9] 서버시간 응답 (18 + 바디 12 + 2) [cite: 983]
        TOTAL_LEN_PSET12_REQ   = 32,   // [12] GW 시간 변경 요청 (18 + 바디 12 + 2) [cite: 1070]

        TOTAL_LEN_PFCC13_REQ   = 30,   // [13] 시설코드 변경 요청 (18 + 바디 5 + 5 + 2) [cite: 1097]

        TOTAL_LEN_PSEP8_REQ    = 36,   // [8] 비밀번호 변경 요청 (18 + 바디 16(암호화) + 2) [cite: 952, 954]
        TOTAL_LEN_PRSI17_REQ   = 36,   // [17] 통신서버IP 변경 요청 (18 + 바디 16(암호화) + 2) [cite: 1188, 1192]

        TOTAL_LEN_PDAT18_REQ   = 21,   // [18] 자료전송모드 변경 요청 (18 + 바디 1 + 2) [cite: 1214]
        TOTAL_LEN_PODT19_REQ   = 26,   // [19] 유예시간 설정 변경 요청 (18 + 바디 3 + 3 + 2) [cite: 1237]

        TOTAL_LEN_PDUH5_REQ    = 40,   // [5] ★복구: 저장자료 요청 (18 + 바디 10 + 10 + 2)
        TOTAL_LEN_PUPG10_REQ   = 151,  // [10] GW 업그레이드 요청 (18 + 바디 131(암호화) + 2) [cite: 1006, 1013]

        // ========================================================================================
        // 2. P 계열 가변 길이 명령어 패킷 최소 크기 (항목수/관계수 n = 1일 때의 최소 바이트)
        // ========================================================================================
        MIN_LEN_PAST14_REQ     = 46,   // [14] ★추가: 측정범위 변경 (헤더 18 + 항목수 2 + 반복 블록 24*1 + CRC 2)
        MIN_LEN_PFRS16_REQ     = 32    // [16] ★추가: 관계정보 변경 (헤더 18 + 관계수 2 + 반복 블록 10*1 + CRC 2)
